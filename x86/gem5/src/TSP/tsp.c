...
static void intern_update_minimum_distance(tsp_t_pointer tsp, int new_distance) {
...
static partition_interval_t get_next_partition_block_size(int nb_partitions, int *next_partition, int block_size, int processed_partitions) {
